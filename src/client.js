...
exports.getAllCafes = exports.Cafe = void 0;
 ...
 */
var Cafe = /** @class */ (function (_super) {
    __extends(Cafe, _super);
    function Cafe() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return Cafe;
}(kontent_delivery_1.ContentItem));
exports.Cafe = Cafe;
var deliveryClient = new kontent_delivery_1.DeliveryClient({
    projectId: "b61a77df-b2e3-0095-a454-64ffc39d06d3",
    typeResolvers: [new kontent_delivery_1.TypeResolver("cafe", function () { return new Cafe(); })]
});
/** Getting items from Kentico Kontent as a Promise */
/** Getting items from Kentico Kontent as Observable??? */
exports.getAllCafes = function () { return __awaiter(void 0, void 0, void 0, function () {
    var cafeList;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, deliveryClient
                    .items()
                    .type("cafe")
                    .toPromise()
                    .then(function (response) {
                    var cafeText = response.items;
                    return cafeText;
                })];
            case 1:
                cafeList = _a.sent();
                return [2 /*return*/, cafeList];
        }
    });
}); };
// getAllCafes();
